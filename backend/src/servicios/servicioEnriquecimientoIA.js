...
function construirGuiaFormatoCampo(campo, tipo) {
  const guias = {
    ...
    storage_interfaz: 'string corto. Ejemplos: "SATA", "PCIe 4.0", "NVMe".',
    storage_form_factor: 'string corto. Ejemplos: "2.5", "M.2 2280", "3.5".',
    storage_nvme_gen: 'string corto. Ejemplos: "Gen3", "Gen4", "Gen5".',
    ...
    psu_certificacion: 'string corto. Ejemplos: "80 Plus Bronze", "80 Plus Gold".',
    psu_modular: 'boolean true o false.',
    ...
    case_panel_lateral: 'string corto. Ejemplos: "Vidrio templado", "Acrílico", "Malla".',
